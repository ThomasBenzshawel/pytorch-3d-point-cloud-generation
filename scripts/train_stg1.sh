python3 train_stg1.py --model ORIG_STG1 --experiment adam_trueWD \
	--endEpoch 1000 \
...
# python3 train_stg1.py --model ORIG_STG1 --experiment adam_trueWD_1K \
# 	--endEpoch 100 \
# 	--chunkSize 100 --batchSize 100 \
# 	--optim adam --trueWD 1e-4 --lr 5e-3 \
# 	--gpu 1
...
# python3 train_stg1.py --model ORIG_STG1 --experiment adam_trueWD_restart \
# 	--endEpoch 1000 \
# 	--chunkSize 100 --batchSize 100 \
